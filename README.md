...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/tokenize-rt-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/tokenize-rt-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/tokenize-rt-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/tokenize-rt-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/tokenize-rt-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/tokenize-rt-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `tokenize-rt` can be installed with:

```
conda install tokenize-rt
```

It is possible to list all of the versions of `tokenize-rt` available on your platform with:
